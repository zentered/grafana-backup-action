...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(484))
  }
}
...
/* harmony import */ var _lib_write_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(365);
/* harmony import */ var _lib_grafana_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(552);
...
__nccwpck_require__.d(__webpack_exports__, {
  "AK": () => (/* binding */ fetchDashboard),
  "j2": () => (/* binding */ fetchDashboards),
  "F5": () => (/* binding */ fetchFolders)
});

// EXTERNAL MODULE: ./config.js
var config = __nccwpck_require__(79);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/fetch-blob@3.2.0/node_modules/fetch-blob/from.js + 1 modules
var from = __nccwpck_require__(939);
...
;// CONCATENATED MODULE: ./lib/grafana.js



const fetchGrafana = async (query) => {
  const res = await fetch(`https://${config/* grafanaOrg */.oY}.grafana.net/api/${query}`, {
    headers: {
      Authorization: `Bearer ${config/* grafanaApiKey */.E1}`
    }
  })
  return res.json()
}
...
const backupDir = config/* overwriteFiles */.rZ
  ? (0,external_node_path_.join)(process.cwd(), config/* outputFolder */.yV)
  : (0,external_node_path_.join)(process.cwd(), config/* outputFolder */.yV, datePrefix)
...
const write = async (filename, data) => {
  ...
  const file = (0,external_node_path_.join)(backupDir, filename)
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(967);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(348);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(967);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(564);
